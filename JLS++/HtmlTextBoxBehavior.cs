...
namespace JLS__
{
    ...
    public class HtmlRichTextBoxBehavior : DependencyObject
    {
          ...
          DependencyPropertyChangedEventArgs e)
        {
            ...
            var flowDocument = XamlReader.Parse(xaml) as System.Windows.Documents.FlowDocument;
            HyperlinksSubscriptions(flowDocument);
            richTextBox.Document = flowDocument;
        }

        private static void HyperlinksSubscriptions(System.Windows.Documents.FlowDocument flowDocument)
        {
